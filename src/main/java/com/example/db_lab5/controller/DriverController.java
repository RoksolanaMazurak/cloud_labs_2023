...
public class DriverController {
    ...
    @Transactional
    @PostMapping(value = "/insertTenDrivers")
    public ResponseEntity<DriverDto> insertTenDrivers() {
        driverService.insertDrivers();
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @Transactional
    @PostMapping(value = "/connectDriverAndCar")
    public ResponseEntity<?> connectDriverAndCar(String driverSurname, String carNum) {
        driverService.connectDriverAndCar(driverSurname, carNum);
        return new ResponseEntity<>(HttpStatus.OK);
    }
}